        ...
        <div className="flex flex-col space-y-8 justify-center items-center">
          <div className="flex flex-col justify-center items-center space-y-5">
            ...
            <IconClickableWithAnimation
              Icon={GithubIcon}
              href={"https://github.com/Abhishek1322/my-portfolio"}
            />
            {/* Linkedin icon */}
            <IconClickableWithAnimation
              Icon={LinkedinIcon}
              href={"https://www.linkedin.com/in/abhishek-kumar-b86b94226/"}
            />
            {/* Instagram Icon */}
            ...
            <IconClickableWithAnimation
              Icon={InstagramIcon}
              href={
                "https://www.instagram.com/itzz__abhishekk?igsh=NXBmMGZ2azM4djVt"
              }
            />
          </div>
          ...
          >
            ...
            >
              <span className=" font-Header tracking-wider text-gray-400 hover:text-AAsecondary hover:cursor-pointer">
                abhishekbalongi<span className="text-AAsecondary">@</span>
